    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="dashboard.php" class="brand-link">
                ...
                <span class="brand-text font-weight-light">CAFÉBuenísimo</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <p>
                                    <?php 
                                    // Cambia el texto del menú según el rol
                                    if ($_SESSION['rol'] == 5) {
                                        echo 'Pedidos';
                                    } else {
                                        echo 'Ventas';
                            ...
                            <ul class="nav nav-treeview">
                                <?php 
                                // Cambia el texto de "Nueva venta" y "Historial ventas" según el rol
                                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 3 || $_SESSION['rol'] == 5) {
                                    echo '<li class="nav-item">
                                        <a href="index.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>' . ($_SESSION['rol'] == 5 ? 'Nuevo pedido' : 'Nueva venta') . '</p>
                                        </a>
                                    </li>';
                                } 
                                if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2 || $_SESSION['rol'] == 5) {
                                    echo '<li class="nav-item">
                                        <a href="lista_ventas.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>' . ($_SESSION['rol'] == 5 ? 'Historial pedidos' : 'Historial ventas') . '</p>
                                        </a>
                                    </li>';
                                } 
                                ?>
