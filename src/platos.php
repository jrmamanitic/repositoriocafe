                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Ingrese nombre del producto" name="plato" id="plato" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    if ($result > 0) {
                                        while ($data = mysqli_fetch_assoc($query)) { ?>
                                            <tr>
                                                ...
                                                <td><img class="img-thumbnail" src="<?php echo ($data['imagen'] == null) ? '../imagenes/' . htmlspecialchars($data['id']) . '.jpg' : $data['imagen']; ?>" 
                                                class="product-image" alt="" width="200"  ></td>
